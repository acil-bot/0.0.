...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            elif ["Me","Gu","Phet"] == msg.text:
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif ["Mee","Me Gu","Me Phet"]== msg.text:
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
                cl.sendMessage(msg)
...
#-----------------------------------------------
                        ...
                        ki4.sendText(msg.to,"สวัสดีทุกคนครับ..")
                        ki5.sendText(msg.to,"สวัสดีทุกคนครับ..")
                        print "kicker ok"
                        G.preventJoinByTicket = True
                        ki.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki4.sendText(msg.to,"Bye~Bye~ไปละ..😂")
                    ki5.sendText(msg.to,"Bye~Bye~เดี๋ยวมาใหม่..😂")
                    print "kicker ok"
                    try:
...
#-----------------------------------------------
                ...
                ki3.sendText(msg.to,"Test ok... ")
                ki4.sendText(msg.to,"Test ok... ")
                ki5.sendText(msg.to,"Test ok..Phet...")
#-----------------------------------------------
