...
ki6mid = ki5.getProfile().mid
ki7mid = ki5.getProfile().mid
wait = {
    'contact':True,
    'autoJoin':False,
...
#-----------------------------------------------
                        ...
                        ki6.sendText(msg.to,"Phet hack bot❗")
                        ki7.sendText(msg.to,"สวัสดีทุกคนครับ..❗")
                        print "kicker ok"
                        G.preventJoinByTicket = True
                        ki.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki3.sendText(msg.to,"Bye~Bye~Gu😂")
                    ki5.sendText(msg.to,"Bye~Bye~All😂")
                    ki6.sendText(msg.to,"Bye~Bye~ไปละ..😂")
                    ki7.sendText(msg.to,"Bye~Bye~เดี๋ยวมาใหม่..😂")
                    print "kicker ok"
                    try:
...
#-----------------------------------------------
                ...
                ki5.sendText(msg.to,"Test ok...❗")
                ki6.sendText(msg.to,"Test ok...❗")
                ki7.sendText(msg.to,"Test ok..Phet...❗❗")
#-----------------------------------------------
