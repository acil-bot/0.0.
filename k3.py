    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                ki.sendText(msg.to,kimid)
                ki2.sendText(msg.to,ki2mid)
                k3.sendText(msg.to,ki3mid)
                ki3.sendText(msg.to,ki3mid)
                ki.sendText(msg.to,kimid)
                ki2.sendText(msg.to,ki2mid)
                ki3.sendText(msg.to,ki3mid)
                ki.sendText(msg.to,kimid)
                ki2.sendText(msg.to,kl2mid)
                ki3.sendText(msg.to,ki3mid)
            elif "Ps1" == msg.text:
                msg.contentType = 7
                msg.text = None
...
#--------------------------------------------------------
                ...
                kk.sendText(msg.to,md)
                k2.sendText(msg.to,md)
                k3.sendText(msg.to,md)
...
#-----------------------------------------------------------
                ...
                ki2.sendText(msg.to,"Bot 5🔥")
                ki3.sendText(msg.to,"Bot 6🔥")
                ki.sendText(msg.to,"Bot 7🔥")
                ki2.sendText(msg.to,"Bot 8🔥")
                ki3.sendText(msg.to,"Bot 9🔥")
                ki.sendText(msg.to,"Bot 10🔥")
                ki2.sendText(msg.to,"Bot 8🔥")
                ki3.sendText(msg.to,"Bot 9🔥")
#-----------------------------------------------------------speed
...
#-----------------------------------------------
                        ...
                        ki2.sendText(msg.to,"Hello all..")
                        ki3.sendText(msg.to,"Phet hack bot")
                        print "kicker ok"
                        G.preventJoinByTicket = True
                        ki.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki2.sendText(msg.to,"Bye~Bye~Gu😂")
                    ki3.sendText(msg.to,"Bye~Bye~All😂")
                    print "kicker ok"
                    try:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Test ok... ")
                ki2.sendText(msg.to,"Test ok... ")
                ki3.sendText(msg.to,"Test ok..Phet...")
#-----------------------------------------------
...
#-----------------------------------------------
                ...
                kl.sendText(msg.to, "%s second" % (elapsed_time))
                kl2.sendText(msg.to, "%s second" % (elapsed_time))
                kl3.sendText(msg.to, "%s second" % (elapsed_time))
#-------------------------------------------------------------------蹴り返し
        if op.type == 19:
            try:
                if op.param3 in mid:
