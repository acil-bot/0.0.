...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uf66f73f5393a7eccb707f59183ce9625":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                return
            elif msg.text in ["help","ヘルツ1�7","へるい1�7"]:
                if wait["lang"] == "JP":
                ...
                msg.text = None
                ki2.sendMessage(msg)
            elif msg.text in ["キャンセツ1�7","Cancel","取消還1�7諄1�7"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
                    if group.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"No one is inviting〄1�7")
                        else:
                            cl.sendText(msg.to,"Sorry, nobody absent〄1�7")
                else:
                    if wait["lang"] == "JP":
