...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            elif "Pmid:" in msg.text:
                midd = msg.text.replace("Pmid","")
...
#--------------------------------------------------------
            ...
            elif msg.text in ["Cancell","ลบรัน"]:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    ki9.sendText(msg.to,"Done Gu...❗")
                                    ki10.sendText(msg.to,"Done Tom...❗")
                                except:
                                    cl.sendText(msg.to,"error❗")
            elif "Wl: @" in msg.text:
...
#-----------------------------------------------
                        ...
                        ki4.sendText(msg.to,"[" + str(ginfo.name) + "]\n\n" + "[By.Gυ Tєʌм HʌcκBoт]")
