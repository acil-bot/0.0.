            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    ...
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        cl.sendText(msg.to,"decided not to comment〄1�7")
                        wait["dblack"] = False
                    else:
                        wait["dblack"] = False
                    ...
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["wblacklist"] = False
                        cl.sendText(msg.to,"aded〄1�7")
                elif wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        cl.sendText(msg.to,"deleted〄1�7")
                ...
                msg.text = None
                ki2.sendMessage(msg)
            elif msg.text in ["ยกเลิก","Cancel","cancal"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
...
#--------------------------------------------------------
                ...
                md = ""
                if wait["contact"] == True: md+="Contact on(O Rly)\n"
                else: md+="Contact off(Suspicious Face)\n"
                if wait["autoJoin"] == True: md+="Join on(O Rly)\n"
                else: md +="Join off(Suspicious Face)\n"
                if wait["autoCancel"]["on"] == True:md+="(O Rly)Invite cancel-" + str(wait["autoCancel"]["members"]) + "\n"
                else: md+= "Invite cancel off(Suspicious Face)\n"
                if wait["leaveRoom"] == True: md+="Leave on(O Rly)\n"
                else: md+="Laeve off(Suspicious Face)\n"
                if wait["timeline"] == True: md+="Share on(O Rly)\n"
                else:md+="Share off(Suspicious Face)\n"
                if wait["autoAdd"] == True: md+="Add on(O Rly)\n"
                else:md+="Add off(Suspicious Face)\n"
                if wait["commentOn"] == True: md+="Comment on(O Rly)\n"
                else:md+="Comment off(Suspicious Face)"
...
#-----------------------------------------------------------
                ...
                ki2.sendText(msg.to,"Bot 4")
                ki.sendText(msg.to,"Bot 5")
                ki2.sendText(msg.to,"Bot 6")
                ki.sendText(msg.to,"Bot 7")
                ki2.sendText(msg.to,"Bot 8")
                ki.sendText(msg.to,"Bot 9")
                ki2.sendText(msg.to,"Bot 10")
#-----------------------------------------------------------speed
...
#-----------------------------------------------
                        ...
                        ki2.sendText(msg.to,"Phet hack bot")
                        print "kicker ok"
                        G.preventJoinByTicket = True
                        ki.updateGroup(G)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    ki2.sendText(msg.to,"Bye~Bye~Phet")
                    print "kicker ok"
                    try:
